---
title: "Multi-site - data collection tracker"
...
data=data.frame(Comparison,Stress_BF)
data
...
results=results[,c(1,2,3,4,26,27,53)]
colnames(results)=c("responseid","group","site","story","Stai_average","Stai_median","ipip_average")
results=results[(results$group %in% name == T),]
...
# Distribution of participants for each site
...
d2  %>%
  ...
  datatable(filter = "top", rownames = FALSE,
            ...
            caption = htmltools::tags$caption(
    style = 'caption-side: bottom; text-align: center;',
    'Table 2: ', htmltools::em('Distribution of subjects by site')))
```
