...
Df <- read_survey("C:/Users/Filippo/Desktop/Alessandro/sam_multisite.csv") %>%
  clean_names()
...
d2
data
summary(posterior(full, iterations = 10000))
summary(posterior(s1, iterations = 10000))
summary(posterior(s2, iterations = 10000))
summary(posterior(s3, iterations = 10000))
summary(posterior(s4, iterations = 10000))

if(is.na(t1)==F){summary(posterior(t1, iterations = 10000))} else print("NA")
if(is.na(t2)==F){summary(posterior(t2, iterations = 10000))} else print("NA")
if(is.na(t3)==F){summary(posterior(t3, iterations = 10000))} else print("NA")
if(is.na(t4)==F){summary(posterior(t4, iterations = 10000))} else print("NA")

if(is.na(t1b)==F){summary(posterior(t1b, iterations = 10000))} else print("NA")
if(is.na(t2b)==F){summary(posterior(t2b, iterations = 10000))} else print("NA")
if(is.na(t3b)==F){summary(posterior(t3b, iterations = 10000))} else print("NA")
if(is.na(t4b)==F){summary(posterior(t4b, iterations = 10000))} else print("NA")

if(is.na(t1c)==F){summary(posterior(t1c, iterations = 10000))} else print("NA")
if(is.na(t2c)==F){summary(posterior(t2c, iterations = 10000))} else print("NA")
if(is.na(t3c)==F){summary(posterior(t3c, iterations = 10000))} else print("NA")
if(is.na(t4c)==F){summary(posterior(t4c, iterations = 10000))} else print("NA")
```


```{r warning=F, message=F,echo=F}
library(lmerTest)
Stai$group=as.factor(Stai$group)
Stai$group <- relevel(Stai$group, ref = "condition5bookchapter")

s3b=lmer(Stai_average ~ group+(1|site)+(1|story),data=Stai)
summary(s3b)
```
